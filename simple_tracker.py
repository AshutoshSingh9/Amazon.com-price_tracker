...
# # step 2: Go to amazaon site
# # step 3: look for the items link 
# # step 4: put in the searc bar for the items we looking for
# # step 5: go through multiple pages(scrape all the products and get all links)
# # step 6: Loop through each link and loop and get a link from each product
# # step 7: Create a JSON report file
